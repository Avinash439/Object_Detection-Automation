...
Example usage:
    python create_coco_tf_record.py --logtostderr \
      --train_image_dir="/root/lab/Thomas/new/trainval/images/" \
      --val_image_dir="/root/lab/Thomas/new/trainval/images/" \
      --test_image_dir="/root/lab/Thomas/new/trainval/images/" \
      --train_annotations_file="/root/lab/Thomas/new/trainval/annotations/train.json" \
      --val_annotations_file="/root/lab/Thomas/new/trainval/annotations/val.json" \
      --testdev_annotations_file="/root/lab/Thomas/new/trainval/annotations/test.json" \
      --output_dir="/root/lab/Thomas/new/trainval/tfrecords/"
"""
...
def create_tf_example(image,
  ...
  for object_annotations in annotations_list:
    if object_annotations['bbox'] is not None:
      #print(object_annotations['bbox'])
      ...
      if x + width > image_width or y + height > image_height:
        print("width/height: image crossing")
        num_annotations_skipped += 1
        continue
...
def _create_tf_record_from_coco_annotations(annotations_file, image_dir,
  ...
  with contextlib2.ExitStack() as tf_record_close_stack, \
    ...
    print('Finished writing, skipped ', total_num_annotations_skipped, ' annotations.')
    if keypoint_annotations_file:
...
# def out_path(output_dir):
  # assert FLAGS.train_image_dir, '`train_image_dir` missing.'
  # # assert FLAGS.val_image_dir, '`val_image_dir` missing.'
  # assert FLAGS.test_image_dir, '`test_image_dir` missing.'s
...
def create_tf_record_dirs(output_dir):
  ...
  return train_output_path, testdev_output_path
 
  # _create_tf_record_from_coco_annotations(
  #   annotations_file = "/home/ob_reserverd_cu/scripts/static/store_data/nh070/tet1/train.json",
  #   image_dir="/AI_OD/root/lab/prime_team_projects/data",
  #   output_path="/home/ob_reserverd_cu/scripts/static/store_data/nh070/tet1/tf_record/",
  #   include_masks=False,
  #   num_shards=500,
  #   keypoint_annotations_file='',
  #   densepose_annotations_file='',
  ...
  # _create_tf_record_from_coco_annotations(
  #   annotations_file="/home/ob_reserverd_cu/scripts/static/store_data/nh070/tet1/test.json", 
  #   image_dir="/AI_OD/root/lab/prime_team_projects/data",
  #   output_path="/home/ob_reserverd_cu/scripts/static/store_data/nh070/tet1/tf_record/",
  #   include_masks=False,
  #   num_shards=50)
